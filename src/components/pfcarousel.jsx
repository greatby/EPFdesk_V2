...
const services = [
  {
    title: "Multi-State Complexity",
    description:
      "Different PT slabs, rates, and rules across 15+ states. We handle all variations seamlessly.",
  },
  {
    title: "Monthly Deduction Management",
    description:
      "Accurate PT calculation based on statespecific salary slabs and employee categories.",
  },
  {
    title: "Annual Return Filing",
    description:
      "State-wise annual returns, renewals, and compliance certificate generation.",
  },
  {
    title: "Registration Management",
    description:
      "New location registrations, certificate renewals, and amendment processing.",
  },
];
      ...
      <div className="max-w-7xl mx-auto hidden md:flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="w-full md:w-1/3 lg:w-1/3 text-center md:text-left mb-8 md:mb-0">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Professional Tax Compliance Simplified
          </h2>
