...
//   {
//     title: "Lead",
//     subtitle: "Guide others to success",
//     icon: "👑",
//     bubble: "Lead!",
//     bg: "bg-gradient-to-br from-[#89f7fe] to-[#66a6ff]",
//   },
//   {
//     title: "Celebrate",
//     subtitle: "Enjoy every achievement",
//     icon: "🎉",
//     bubble: "Celebrate!",
//     bg: "bg-gradient-to-br from-[#fdbb2d] to-[#22c1c3]",
//   },
];
...
const VerticalCard = ({ title, subtitle, icon, bubble, bg }) => (
  <div className={`relative ${bg} p-10 rounded-3xl shadow-xl transition hover:-translate-y-2 hover:shadow-2xl flex flex-col items-center justify-center`}>
...
const HorizontalCard = ({ title, subtitle, icon, bubble, bg }) => (
  <div className={`relative ${bg} p-8 rounded-3xl shadow-xl transition hover:-translate-y-2 hover:shadow-2xl flex flex-col md:flex-row items-center md:items-start`}>
    <div className="absolute inset-0 pointer-events-none">
      <FloatingCircles />
    </div>
    <div className="absolute top-3 right-3 bg-white/90 rounded-xl px-3 py-1 text-xs font-semibold text-gray-700 shadow-md opacity-0 scale-95 transition hover:opacity-100 hover:scale-100">
    ...
    <div className="relative w-20 h-20 bg-white rounded-full flex items-center justify-center text-4xl shadow-md z-10 mb-4 md:mb-0 md:mr-6">
      {icon}
    </div>
  ...
  return (
    <div className="min-h-screen px-4 py-16">
      <div className="max-w-[1400px] mx-auto">
        <h2 className="text-3xl font-extrabold text-center text-gray-800 mb-12">Vertical Cards</h2>
        ...
        <h2 className="text-3xl font-extrabold text-center text-gray-800 mb-12">Horizontal Cards</h2>
